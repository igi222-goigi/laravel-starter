...
Route::group(['middleware' => 'auth'], function () {
	...
	// banner Route
	// Route::group(['middleware' => 'can:manage_banners'], function () {
	// 	Route::get('/banners', [BannerController::class, 'index']);
	// 	Route::get('/banners/get-list', [BannerController::class, 'getBannerList']);
	// });

	Route::get('/banners', [BannerController::class, 'index']);
	Route::get('/banners/get-list', [BannerController::class, 'getBannerList']);
	Route::get('/banners/create', [BannerController::class, 'create']);
	Route::post('/banners/create', [BannerController::class, 'store'])->name('create-banner');
	Route::get('/banners/{id}', [BannerController::class, 'edit']);
